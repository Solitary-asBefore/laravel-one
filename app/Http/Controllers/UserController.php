...
namespace app\appapi\model\user;

use app\core\model\user\UserBill;
use app\appapi\model\store\StoreOrder;
...
class User extends ModelBasic
{
     ...
     * @return array
     */
    public static function getPasswordUser($phone, $password)
    {
        $where = [
            'phone' => $phone,
            'pwd' => md5($password)
     ...
     * @return array
     */
    public static function getPhoneUser($phone)
    {
        $where = [
            'phone' => $phone,
        ];
